 ...
 */
public class Blocks {
    public static void getBlocksList(int count, int page, JsonCallback<BlockListModel> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("count", String.valueOf(count));
        param.put("page", String.valueOf(page));
        HttpHelper.getAsync(Constants.BLOCKS_LIST, param, callback);
    }
    public static void getBlocksList(JsonCallback<BlockListModel> callback) throws InvalidAccessTokenException {
        getBlocksList(50, 1, callback);
    }
    public static void addBlock(long uid, JsonCallback<UserModel> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("uid", String.valueOf(uid));
        HttpHelper.postAsync(Constants.BLOCKS_CREATE, param, callback);
    }
    public static void removeBlock(long uid, JsonCallback<UserModel> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("uid", String.valueOf(uid));
        HttpHelper.postAsync(Constants.BLOCKS_DESTROY, param, callback);
    }
    public static void isBlocked(long uid, boolean invert, JsonCallback<String> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("uid", String.valueOf(uid));
        param.put("invert", invert? "0" : "1");
        HttpHelper.getAsync(Constants.BLOCKS_EXISTS, param, callback);
    }
    public static void isBlocked(long uid, JsonCallback<String> callback) throws InvalidAccessTokenException {
