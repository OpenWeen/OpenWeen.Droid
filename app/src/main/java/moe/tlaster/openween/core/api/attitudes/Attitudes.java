...
public class Attitudes {
    public static void like(long id, JsonCallback<String> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("attitude", "smile");
        param.put("id", String.valueOf(id));
        HttpHelper.postAsync(Constants.ATTITUDE_CREATE, param, callback);
    }
    public static void unLike(long id, JsonCallback<String> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("id", String.valueOf(id));
