...
public class Mentions {
    public static void getMentions(long since_id, long max_id, int count, int page, AuthorType filter_by_author, SourceType filter_by_source, FeatureType filter_by_type, JsonCallback<MessageListModel> callback) {
    ...
    public static void getMentions(int count, JsonCallback<MessageListModel> callback) {
        getMentions(0, 0, count, 1, AuthorType.All, SourceType.All, FeatureType.All, callback);
    }
    public static void getMentions(long max_id, int count, JsonCallback<MessageListModel> callback){
        getMentions(0, max_id, count, 1, AuthorType.All, SourceType.All, FeatureType.All, callback);
    }
