...
public class ShortUrl {
    public static void shorten(String url, JsonCallback<String> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("url_long", url);
        HttpHelper.getAsync(Constants.SHORT_URL_SHORTEN, param, callback);
    }
    public static void expand(String url, JsonCallback<String> callback) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        param.put("url_short", url);
        HttpHelper.getAsync(Constants.SHORT_URL_EXPAND, param, callback);
    }
    public static void info(JsonCallback<UrlInfoListModel> callback, String... urls) throws InvalidAccessTokenException {
        Map<String, String> param = new HashMap<>();
        for (String url : urls) {
            param.put("url_short", url);
        }
