...
public class HttpHelper {
    public static void getAsync(String url, Map<String, String> param, JsonCallback callback) {
    ...
    public static void postAsync(String url, Map<String, String> data, JsonCallback callback) {
        if (TextUtils.isEmpty(Entity.getAccessToken())){
            callback.onError(null, new InvalidAccessTokenException(), -1);
            return;
        }
    ...
    public static void uploadFileAsync(String url, File file, JsonCallback callback) {
        if (TextUtils.isEmpty(Entity.getAccessToken())){
            callback.onError(null, new InvalidAccessTokenException(), -1);
            return;
        }
    ...
    public static void uploadFileWithParamAsync(String url, File file, Map<String, String> data, JsonCallback callback) {
        if (TextUtils.isEmpty(Entity.getAccessToken())){
            callback.onError(null, new InvalidAccessTokenException(), -1);
            return;
        }
